...
import { selectLoding, selectLoggedInUser } from '../../reducers/auth/authReducer';
                    ...
                    <div className='container flex flex-col gap-4'>
                        <div className='flex items-center'>
                            <div className='flex flex-col w-full'>
                                <label htmlFor='name' className='For-medium text-gray-600'>
                                    Name
                                </label>
                        ...
                        <div className='flex items-center'>
                            <div className='flex flex-col w-full'>
                                <label htmlFor='email' className='For-medium text-gray-600'>
                                    Email
                                </label>
                                <div className='relative'>
                                    <input
